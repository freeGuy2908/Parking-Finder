      ...
      <ScrollView style={styles.content}>
        <View style={styles.profileSection}>
          ...
          <View style={styles.profileInfo}>
            <Text style={styles.profileName}>Nguyễn Văn B</Text>
            <Text style={styles.profileEmail}>nguyenvanb@example.com</Text>
            <View style={styles.ownerBadge}>
              <Text style={styles.ownerBadgeText}>Chủ bãi đỗ xe</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.menuSection}>
          ...
          <TouchableOpacity style={styles.menuItem}>
            <View style={styles.menuItemLeft}>
              ...
              <Text style={styles.menuItemText}>Giấy tờ pháp lý</Text>
            </View>
            <ChevronRight size={20} color="#9CA3AF" />
          </TouchableOpacity>
        </View>
